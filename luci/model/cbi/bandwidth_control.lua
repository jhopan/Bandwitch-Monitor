...
local used=dev:option(DummyValue,"used",translate("Usage")); function used.cfgvalue(self,s) local mac=self.map.uci:get("bandwidth-control",s,"mac") or ""; local _,_,n=usage(mac); local q=tonumber((self.map.uci:get("bandwidth-control",s,"quota_gb") or "0"):gsub(",",".")) or 0; local pct=q>0 and math.floor(n/(q*1073741824)*100) or 0; return string.format("%s / %s GB (%d%%)",fmt(n),q,pct) end
